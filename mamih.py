...
#cl.login(qr=True)
cl.login(token="Eoxm4pBxAF7Q476P3z1a.eSx8MBEObAntrYRMbUil2G.p20z2l/I7XHYvdIRomPZdNSxYaHKxCfTbkvB4cwWy2s=")
cl.loginResult()
...
-==================-
✰====􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺T-B-A༻ 􀂳􏿿=====✰
Khusus Admin and Owner
-==================-
"""
Setgroup ="""􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺T-B-A༻ 􀂳􏿿
◄]Menu For Admin[►
-==================-
line://ti/p/~jkp4678
-==================-
...
owner=["u12c5fc99b7a805a353472ae606e20bda"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#===========================================
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺T-B-A༻ 􀂳􏿿")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"★★★★★★")
                cl.sendText(msg.to,"★★★★★★★")
                cl.sendText(msg.to,"Semua Hadir Boss  􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺T-B-A༻ 􀂳􏿿")
...
#------------------------------------------------------------------------------------
        if op.type == 32:
			OWN = "u12c5fc99b7a805a353472ae606e20bda"
...
#---------------------
        ...
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "Bkenapa dia 😊")
